...
const API_URL = 'http://192.168.0.132:3001/api/auth';
...
class AuthStore {
  ...
  async register(userData: any): Promise<User> {
    ...
    const registerData = {
      ...
      ...(userData.license_number && { license_number: userData.license_number }),
      ...(userData.manager_username && { manager_username: userData.manager_username }),
      ...
      ...(userData.license_expire_date && { license_expire_date: userData.license_expire_date }),
      ...(userData.blood_group && { blood_group: userData.blood_group }),
      ...(userData.emergency_contact_number && { emergency_contact_number: userData.emergency_contact_number }),
